        ...
        >
          ...
          >
            <div
              ...
              :class="{
                  'm-today': day.isToday,
                  'rlbg2':!day.isFull && !day.isDisable,
                  'rlbg1':day.isFull
                }"
            >
              <span
              ...
              >
                {{day.value}}
                <p class="todaya" v-if="day.isToday">今天</p>
                <p class="todaya" v-if="day.isFull">已满</p>
                <p class="todaya" v-if="!day.isFull && !day.isDisable && !day.isToday && !day.isSelect">可约</p>
                <p class="todaya" v-if="day.isSelect">已约</p>
              </span>
...
export default {
  ...
  methods: {
    ...
    isFull(date){
      ...
      // switch (this.$props.mode) {
      // case 'single':
      //   if (this.fullList && date.isSame(this.fullList)) {
      //     select = true;
      //   }
      //   break;
      // case 'multiple':
      ...
      for(let i=0;i<this.fullList.length;i++){
        if (date.isSame(this.fullList[i])) {
          select = true;
        }
      }
      return select;
